...
// 		command
// 			.setName("view")
// 			.setDescription("Displays the settings configured for this server.")
// 	)
...
// 				command
// 					.setName(`view`)
// 					.setDescription(`View all welcome and goodbye related settings.`)
// 			)
// 			.addSubcommand((command) =>
// 				command
// 					.setName("enable")
...
// 				command
// 					.setName(`view`)
// 					.setDescription(`View all starboard related settings.`)
// 			)
// 			.addSubcommand((command) =>
// 				command
// 					.setName("disable")
...
// 			.addSubcommand((command) =>
// 				command.setName(`view`).setDescription(`View all logged Admin Roles.`)
// 			)
// 			.addSubcommand((command) =>
// 				command
// 					.setName("add")
...
// 				command
// 					.setName(`view`)
// 					.setDescription(`View all logged Moderator Roles.`)
// 			)
// 			.addSubcommand((command) =>
// 				command
// 					.setName("add")
...
// 				command
// 					.setName(`view`)
// 					.setDescription(`View all ticket related settings.`)
// 			)
// 			.addSubcommand((command) =>
// 				command
// 					.setName("enable")
